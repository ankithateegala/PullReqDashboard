...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *PullReqDashboard.API*):

Restore dependencies
```
    cd "PullReqDashboard.API"
    dotnet restore
```

Execute unit tests
```
    cd "PullReqDashboard.API/test/PullReqDashboard.API.Tests"
    dotnet test
```

Deploy application
```
    cd "PullReqDashboard.API/src/PullReqDashboard.API"
